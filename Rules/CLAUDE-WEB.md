...
<PYTHON>
- Python 3.14+ features. Use `uvx ty check` for type checking
...
- **You must not state something is fixed unless you have confirmed it by testing or verifying the output**
