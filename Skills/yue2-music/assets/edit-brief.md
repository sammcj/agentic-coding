<!-- Template: the orchestrating agent fills {goal} and {instrumentation} per task before handing this to the editing agent. -->
# Score-editing task
...
- Instrumentation: {instrumentation}. Name any instrument to omit explicitly.
