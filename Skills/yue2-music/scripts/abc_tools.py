#!/usr/bin/env python3
"""Inspect, strip chords from and compare the two-voice ABC dialect used by YuE2 and SheetSage2.

Standard library only; times are exact quarter-note fractions. Dialect scope: references/abc-editing.md.
"""
...
def main() -> int:
    ...
    strip.add_argument("--keep-voice", choices=("both", *VOICES), default="both",
                       help="voice to keep; the other becomes rests")
