...
Use the bundled `scripts/eval_triggering.py` (resolve it from this skill's `scripts/` directory). Run it outside any command sandbox (claude/node need network):
