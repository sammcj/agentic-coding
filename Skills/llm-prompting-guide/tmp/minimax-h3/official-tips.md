...
[Skip to main content](https://docs.comfy.org/tutorials/video/minimax/minimax-h3#content-area)

[ComfyUI home page](https://docs.comfy.org/)

[Get Started](https://docs.comfy.org/)[Built-in Nodes](https://docs.comfy.org/built-in-nodes/overview)[Development](https://docs.comfy.org/development/overview)[Support](https://docs.comfy.org/support/contact-support)[Registry API Reference](https://docs.comfy.org/api-reference/admin/generate-a-short-lived-jwt-admin-token)[Cloud API Reference](https://docs.comfy.org/api-reference/cloud/workflow/get-information-about-current-prompt-executions)

# MiniMax H3: ComfyUI Workflow Examples

[MiniMax H3](https://www.minimax.io/blog/minimax-h3) is MiniMax's general-purpose, omni-modal generation model, now available as open weights. It jointly understands text, images, video, and audio in a single context, and generates video with **native stereo audio**: voice, sound effects, and music are modeled together in a single forward pass instead of being layered on afterward. Output is up to 2K resolution, 24fps, and about 15 seconds. ComfyUI natively supports MiniMax H3. The template library currently ships with three example workflows, each covering one generation mode:
...
[](https://docs.comfy.org/tutorials/video/minimax/minimax-h3#key-features)
...
[](https://docs.comfy.org/tutorials/video/minimax/minimax-h3#getting-started)
...
[](https://docs.comfy.org/tutorials/video/minimax/minimax-h3#setting-the-output-resolution)
...
[](https://docs.comfy.org/tutorials/video/minimax/minimax-h3#comfyui-native-workflows)

ComfyUI Native Workflows

###

[](https://docs.comfy.org/tutorials/video/minimax/minimax-h3#minimax-h3-text-to-video-t2v)
...
](https://cloud.comfy.org/?template=video_minimax_h3_t2v&utm_source=docs&utm_medium=referral&utm_campaign=minimax-h3)
...
[](https://docs.comfy.org/tutorials/video/minimax/minimax-h3#model-downloads)

Model downloads

[

## Diffusion Model: minimax\_h3\_fl2va\_pruned\_int8\_convrot
...
## Text Encoder: qwen3vl\_32b\_minimax\_h3\_nvfp4\_awq
...
## VAE: minimax\_h3\_video\_vae\_fp16
...
## VAE: minimax\_h3\_audio\_vae\_fp32
...
[](https://docs.comfy.org/tutorials/video/minimax/minimax-h3#model-storage)
...
[](https://docs.comfy.org/tutorials/video/minimax/minimax-h3#prompting-tips)
...
[](https://docs.comfy.org/tutorials/video/minimax/minimax-h3#prompt-writing-guide)
...
[](https://docs.comfy.org/tutorials/video/minimax/minimax-h3#minimax-h3-image-to-video-i2v)
...
](https://cloud.comfy.org/?template=video_minimax_h3_i2v&utm_source=docs&utm_medium=referral&utm_campaign=minimax-h3)
...
## Input Image: transparent\_rgb\_gaming\_mouse.png
...
[](https://docs.comfy.org/tutorials/video/minimax/minimax-h3#model-downloads-2)
...
[](https://docs.comfy.org/tutorials/video/minimax/minimax-h3#model-storage-2)
...
[](https://docs.comfy.org/tutorials/video/minimax/minimax-h3#prompting-tips-2)
...
[](https://docs.comfy.org/tutorials/video/minimax/minimax-h3#prompt-writing-guide-2)
...
](https://cloud.comfy.org/?template=video_minimax_h3_r2v&utm_source=docs&utm_medium=referral&utm_campaign=minimax-h3)
...
## Reference Image: red\_superboy\_on\_city\_roof.png

Character reference for the workflow, or use your own images.

](https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/red_superboy_on_city_roof.png)

[

## Reference Image: mecha\_dragon\_lightning.png

Style and subject reference for the workflow, or use your own images.

](https://raw.githubusercontent.com/Comfy-Org/workflow_templates/main/input/mecha_dragon_lightning.png)

####

[](https://docs.comfy.org/tutorials/video/minimax/minimax-h3#model-downloads-3)

Model downloads

[

## Diffusion Model: minimax\_h3\_ref2va\_pruned\_int8\_convrot
...
[](https://docs.comfy.org/tutorials/video/minimax/minimax-h3#model-storage-3)
...
[](https://docs.comfy.org/tutorials/video/minimax/minimax-h3#prompt-writing-guide-3)
...
[](https://docs.comfy.org/tutorials/video/minimax/minimax-h3#speeding-up-generation-with-sage-attention)
...
---
Source: [MiniMax H3: ComfyUI Workflow Examples - ComfyUI](https://docs.comfy.org/tutorials/video/minimax/minimax-h3#prompting-tips-3)
